...
export function CTextfieldRrow(prop) {
    return (
        ...
        <div className="max-w-sm">
            ...
            <select id={prop.label + "checkbox"} required
                onChange={prop.onchange}
                    name={prop.name}
                    value={prop.value}
                    className="p-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option value="">{"Choose a "+prop.label}</option>
                {prop.items.map((val,i)=>{
                    return(
