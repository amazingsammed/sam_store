...
import {getProductComboBox, getProducts} from "@/app/_actions/stock_item";



export function ItemListCombo({onChange,onPressed}) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const results = await getProductComboBox(param.storeid);
