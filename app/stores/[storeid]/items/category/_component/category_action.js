...
import {deactivateCategory, deleteCategory, getStockGroup, getStockUnits} from "@/app/_actions/stock_item_options";
...
function CategoryAction({element}) {
    ...
    async function handleDeactivate() {
        await deactivateCategory(element,param.storeid);
        await router.refresh();
    }
    async function handleDelete() {
        await deleteCategory(element,param.storeid);
        await router.refresh();
    }
    return (
        <DropdownMenu>
